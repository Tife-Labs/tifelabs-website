...
import { CheckCircle, Send, MapPin, Mail, Phone, Loader2 } from "lucide-react";
          ...
          <div className="md:col-span-2">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6" noValidate>
              ...
              <div>
                ...
                {errors.service && (
                  <p id="contact-service-error" role="alert" className="mt-1 text-sm text-destructive">
